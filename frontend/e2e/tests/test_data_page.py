...
class TestDataPage:
    ...
    def test_navigates_to_data_page(self, goto_page, assert_no_console_errors):
        """Test can navigate to data page."""
        page = goto_page("/data")
        expect(page.get_by_text("数据管理")).to_be_visible()
        assert_no_console_errors()

    def test_loads_stock_list(self, goto_page, assert_no_console_errors):
    ...
    def test_has_data(self, goto_page, assert_no_console_errors):
    ...
    def test_has_refresh_button(self, goto_page, assert_no_console_errors):
