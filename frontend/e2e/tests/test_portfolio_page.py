...
class TestPortfolioPage:
    def test_navigate_to_portfolios_page(self, goto_page, assert_no_console_errors):
        """Navigate to /portfolios page successfully."""
        page = goto_page("/portfolios")
        expect(page.get_by_text("账户管理")).to_be_visible()
        assert_no_console_errors()

    def test_account_list_loads_with_correct_headers(self, goto_page, assert_no_console_errors):
    ...
    def test_account_list_has_data(self, goto_page, assert_no_console_errors):
    ...
    def test_has_new_account_button(self, goto_page, assert_no_console_errors):
