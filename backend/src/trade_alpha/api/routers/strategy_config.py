...
def _strategy_to_dict(s) -> dict:
    return {
        ...
        "atr_trail_rate": s.atr_trail_rate,
...
async def create_strategy_endpoint(request: StrategyCreateRequest):
    ...
    try:
        s = await create_strategy(
            ...
            sell_rank_pct=request.sell_rank_pct,
            ...
            top_n_retention_pct=request.top_n_retention_pct,
            ...
            atr_trail_rate=request.atr_trail_rate,
            max_daily_buys=request.max_daily_buys,
            rotation_bottom_pct=request.rotation_bottom_pct,
            rotation_rank_min_pct=request.rotation_rank_min_pct,
            rotation_rank_max_pct=request.rotation_rank_max_pct,
